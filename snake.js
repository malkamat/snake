...
function creerPomme() {
    ...
    snake.forEach(function(partieSerpent) {
        const serpentSurPomme = partieSerpent.x  == pommeX && partieSerpent.y == pommeY;
...
function dessinePomme() {
    ...
    ctx.beginPath();
    ctx.arc(pommeX, pommeY, 5, 0, 2 * Math.PI)
    ctx.fill();
    ctx.stroke();
...
>>>>>>> 7b3547d28b0e4e46a1fe177df7881d37b042de1d
}